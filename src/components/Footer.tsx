      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            {/* Bark Reviews */}
            <a 
              href="https://www.bark.com/en/gb/company/md-property-management/ZKP96/?show_reviews=true"
              target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services" className="text-gray-300 hover:text-white">Our Services</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li className="flex items-center">
                ...
                <span>Email: info@mdpropertymanagement.co.uk</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>© {new Date().getFullYear()} MD Property Management. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
