...
const CommercialCleaning: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "thorough sanitization and disinfection of commercial spaces."
    }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">Why Choose Our Commercial Cleaning</h2>
