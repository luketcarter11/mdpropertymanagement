                  ...
                  <>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-800 focus:border-transparent"
                        placeholder="Please provide specific details about your requirements, including property size, frequency of service needed, and any special considerations."
                      ></textarea>
                    </div>
                  </>
                )}
