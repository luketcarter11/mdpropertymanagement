...
const About: React.FC = () => {
  const values = [
    ...
    {
      title: "24/7 Helpline",
      description: "We're always here when you need us, with round-the-clock support for emergencies and inquiries.",
      icon: (
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-xl mb-8">
                More than just a service provider - we're your dedicated partner in maintaining and enhancing your property's value
              </p>
            </div>
          </div>
        </section>
